...
<form id="profile-infos" action="profile" method="POST">
    ...
    <div class="input-row" id="infos2">
        ...
        <div class="input-group">
            ...
            <input id="portanId" type="text" name="portanId" placeholder="Entrez l'identifiant de votre appareil PortAn" <?php if(!is_null($user->getProductId())) echo "value='{$user->getProductId()}'"; ?>>
        </div>
    </div>
    <h2>Mot de passe</h2>
    <hr class="category-hr">
